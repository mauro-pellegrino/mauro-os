# Validation plan: Agency Booked Calls

**Built with:** Offer Validation Cashie (cashie.studio). Captured 17 Aug 2026.
**Status:** plan built, nothing sent.

**The principle:** the only real validation is a paying buyer. Sell it first, work out the details after. Run warm to cold, test small, fix fast.

---

## The pools, as they actually are
...
### Churned clients, one by one

> Hey [name].
>
> I'm helping agency owners get 2 booked calls in 30 days with a lead magnet system built on Claude and because we've connected before I wanted you to be the first to know.
>
> I've made it easy to get started for $200/week.
>
...
> Here: [link].
>
> Have a read and let me know if you're in or if you have any questions because I'm kicking off on [date].
>
> Cool?

### Brando (warm, already asking)

> Hey Brando. I'm actually putting together something around exactly what you're asking about — helping agency owners get 2 booked calls in 30 days with a lead magnet system built on Claude.
>
> I've made it easy to get started for $200/week.
>
> Shall I send you the details?
...
> This month I'm helping agency owners get 2 booked calls in 30 days with a lead magnet system built on Claude.
>
> I've made it easy to get started for $200/week.
>
> DM me "Booked" and I'll get you the details.

### Tracking

A notes app. Who was messaged, what they said, what the next step is. No CRM.
...
The gap is real. The offer says "email me Booked", the hand raiser says "DM me Booked", and there is no landing page, no email platform, no payment processor and no booking link. The `docs/lead-magnet-system-map.md` diagram shows the same break from the other direction.

For a single validation client this doesn't block anything. A DM conversation and an invoice is enough. It blocks the second client, not the first.
