...
| **Analyse an account end to end (4 steps, produces vehicles)** | `skills/research/profile-study.md` |
| Find and save outlier X articles into the corpus | `skills/research/article-corpus.md` |
