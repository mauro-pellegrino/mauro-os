...
**Version 1.3 | Updated 13 March 2026**

Converts any YouTube video script into a visually structured Miro board that mirrors the video's flow. Based on direct analysis of Lorenzo's actual production boards. Use this for the Chrome extension workflow — paste the output brief into Claude in the browser with the Miro extension active.
...
- **Shape type:** Use `rectangle` for all boxes (NOT `round_rectangle`). The only exception is the creator name pill and the Growthub logo badge, which use `round_rectangle`.
...
| Growthub badge | round_rectangle | 350 | 51 | #1a1a1a | #1a1a1a | 0 | 16 |
...
- Yellow filled pill below: round_rectangle, w:350, h:50, fill: #ffdc4a, border: #000000, borderWidth: 0, fontSize: 16 — with creator name (e.g. "Lorenzo Pravata, Co-founder Growthub.Agency")
...
- White text: "G  Growthub Agency · growthub.agency"
...
| Dark Grey/Black | #1a1a1a | All box borders, Growthub badge fill |
...
| White | #ffffff | Growthub badge text |
...
| Shapes | round_rectangle | Creator pill and Growthub logo badge ONLY |
...
| Last content → Growthub badge | 200 |
...
5. End with the Growthub Logo Badge
...
**Script excerpt:** "Why Your Ad Fails Before It Starts. The hook is the first 3 seconds. I've spent $75M on Meta and TikTok across 50+ brands."

```
SECTION 1 — Title Card
ELEMENT: text | TEXT: Why Your Ad Fails Before It Starts — The Hook Formula for 40–45% Hook Rates | W: 777 | FILL: transparent | FS: 36 | STYLE: bold centred
ELEMENT: round_rectangle | TEXT: Lorenzo Pravata, Co-founder Growthub.Agency | W: 350 | H: 50 | FILL: #ffdc4a | BORDER: #000000 | BW: 0 | FS: 16 | STYLE: bold
VISUAL: [IMG: ad spend dashboard showing $75M+ deployed] — rectangle W:400 H:40 FILL:#e6e6e6
ELEMENT: text | TEXT: I've spent the last few years and over $75M deployed on Meta and TikTok across 50+ brands... | W: 773 | FILL: transparent | FS: 18 | STYLE: regular centred
LAYOUT: vertical stack, centred

SECTION 2 — Narration Text Block
ELEMENT: text | TEXT: My name is Lorenzo Pravata, co-founder of Growthub Agency... | W: 773 | FILL: #fff6b6 | FS: 18 | STYLE: regular centred
VISUAL: [IMG: case study dashboard screenshots] — rectangle W:350 H:40 FILL:#e6e6e6
LAYOUT: centred

SECTION 3 — Question Hooks
ELEMENT: rectangle | TEXT: Why do most ads fail? | W: 350 | H: 51 | FILL: #dedaff | BORDER: #1a1a1a | BW: 3 | FS: 18 | STYLE: bold
ELEMENT: rectangle | TEXT: Because of THE HOOK: | W: 350 | H: 51 | FILL: #dedaff | BORDER: #1a1a1a | BW: 3 | FS: 18 | STYLE: bold
LAYOUT: stacked vertically, centred

SECTION 4 — Process / Section Title
ELEMENT: rectangle | TEXT: The Pareto Rule of Ad Performance | W: 695 | H: 102 | FILL: #dedaff | BORDER: #1a1a1a | BW: 3 | FS: 47 | STYLE: bold-italic
LAYOUT: centred
```
