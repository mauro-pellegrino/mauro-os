...
### CTA Pattern (always one of these, never hard sell)
...
## Competitor Patterns to Borrow (Reference Only)

### From Jackson Blackledge (Google ads article)
...
### What Makes an Article Clickable
...
### The 6 Title Patterns + Full Template Bank

**Pattern 1: how-to + credential or constraint**
The how-to alone is not enough. The qualifier is what earns the click.

Templates:
- `how to [verb] [thing] ($[number] [context])`
- `how to [verb] [thing] (in [tight timeframe])`
- `how to [verb] [thing] (step by step playbook)`
...
**Pattern 2: credential number + process**
...
**Pattern 3: the psychology / mechanism behind X**
Names the invisible force. Sounds like insider knowledge.
...
**Pattern 4: the counterintuitive claim**
One sentence that contradicts what the reader already believes. No setup.

Templates:
- `[counterintuitive outcome] if you [unexpected action]`
...
**Pattern 5: i did X. here's what i got.**
First-person investment. Reader gets the lesson without the cost.
...
**Pattern 6: number + thing + outcome**
Quantified value upfront. Reader knows exactly what they're getting.

Templates:
- `[number] [things] that [specific valuable outcome]`
- `[number] levels of [topic] (and how to master each one)`
...
### Thumbnail Principles (from 40 examples)

The thumbnail sets the emotion. The title adds the specificity. They should not repeat each other.

What works:
- Bold text on dark/cinematic background — signals authority and depth
- Real face with strong expression — personal brand, curiosity
- Data or dashboard screenshot — instant credibility for performance claims
- Dramatic or AI-generated art — works for philosophical or big-idea articles

What doesn't work:
- Generic stock photos — forgettable
- Busy images where the text competes — illegible at small size
- Thumbnail that already says what the title says — wastes one of the two assets
...
## Article Images (in-draft prompts)
...
[SECTION 3 HEADER — optional]
[Same pattern]

[CLOSING — 2-3 sentences max]
[CTA — one line, low commitment]
```
...
1. **Image prompts default to hand-drawn doodle illustration** (black ink line art on flat yellow, scene-as-story), per the Jul 8 article cover reference. Infographics become secondary. Added the "Article Images" section.
