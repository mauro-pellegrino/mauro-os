...
- **Invented voice / flattened words.** Personality means Mauro's own words from the raw transcription, not invented metaphors, asides, or words he'd never use (e.g. "scramble"). Do not flatten his raw phrasing into generic filler either. Every distinctive phrase should trace to something he actually said in the source.
...
- [ ] Personality = Mauro's own words: every distinctive phrase traces to the raw transcription, no invented voice or off-voice words (e.g. "scramble")
