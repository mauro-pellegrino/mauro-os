---
name: project_claude_insane_autodm_opener
description: "\"Claude is INSANE for [X]\" is a proven opener for Mauro's Claude-based auto-DM lead gen posts"
metadata: 
  node_type: memory
  type: project
  originSessionId: 86192bc5-f9fa-41cd-9919-cb01f177f84e
---

The opener "Claude is INSANE for [topic]" (e.g. "Claude is INSANE for podcast ads") has worked in the past as the hook line for Mauro's Claude-based auto-DM lead-gen posts (comment-a-keyword → auto-DM delivers a prompt-pack / lead magnet).
